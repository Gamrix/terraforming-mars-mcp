...
- `choose_or_option` previously required `sub_response_json` as a JSON string, which was easy to mis-send as an object.
  - Fixed: parameter renamed to `sub_response` and now accepts a dict directly. Legacy `request` parameter removed.
