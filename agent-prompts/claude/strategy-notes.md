...
33. **CHECK THE MILESTONE CAP EVERY GENERATION (Game 8 repeat of #20).** Codex swept Builder/Gardener/Terraformer by gen 8; I still spent 25 MC on SP City in gen 10 chasing Mayor. Once 3 milestones are claimed the rest are DEAD — the claim option never even appears. Write "milestones claimed: X/3" into every gen's plan before spending toward one.
34. **AWARD RULE VALIDATED (first award win, Game 8): fund only with a structural production lock.** Thermalist funded gen 8 at a 46–3 cube lead with 15-vs-0 heat production → won it. The lock is the opponent having ~0 production in the category, not the current cube gap. This beats the old "15+ lead, gen 10+" heuristic.
35. **Estimate game end from parameter velocity every gen.** Game 8 ended at gen 10 (fastest yet) because Codex ran Regolith Eaters + Water Splitting Plant (+2 oxygen steps/gen). Steps-remaining ÷ table-steps-per-gen = gens left. Stop buying cards whose requirement (oxygen 9–11%!) or payback needs more gens than remain — I wasted ~27 MC of buys on 9 never-played cards (Predators bought gen 2, never playable until gen 10).
36. **2-player plant strategies die without Protected Habitats.** Game 8: Virus (−2 plants), Asteroid (−3 plants), Biomass Combustors (−1 plant prod) all targeted me — 2 greeneries vs 7. Either draft protection early or skip plants entirely; heat/microbe engines were never attacked.
